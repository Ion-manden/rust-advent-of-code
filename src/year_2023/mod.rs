...
pub fn solve() {
    ...
    day_3::part_1::solve(include_str!("day_2/input.txt"));
    day_3::part_2::solve(include_str!("day_2/input.txt"));
    day_4::part_1::solve(include_str!("day_2/input.txt"));
    day_4::part_2::solve(include_str!("day_2/input.txt"));
}
